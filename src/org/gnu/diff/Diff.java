...
public class Diff {
    ...
    /**
     * When set to true, the comparison uses a speed_large_files to speed it
     * up. With this speed_large_files, for files with a constant small density
    ...
    public Diff(Object[] a, Object[] b) {
        Map<Object, Integer> h = new HashMap<Object, Integer>(a.length
                + b.length);
    ...
    private void diag(int xoff, int xlim, int yoff, int ylim,
        ...
        for (int c = 1;; ++c) {
             ...
             * it had succeeded. With this speed_large_files, for files with a
             * constant small density of changes, the algorithm is linear in the
             * file size
             */
     ...
     * known, as a whole, to match each other. The results are recorded in the
     * vectors filevec[N].changed_flag, by storing a 1 in the element for each
     * line that is an insertion or deletion. The subsequence of file 0 is
     * [XOFF, XLIM) and likewise for file 1. Note that XLIM, YLIM are exclusive
     * bounds. All line numbers are origin-0 and discarded lines are not counted.
     */
    ...
    public static class change {
        ...
        change(int line0, int line1, int deleted, int inserted, change old) {
            ...
            this.link = old;
            //            ApplicationFrame.getInstance().getConsole().println(line0 + "," + line1
            //                    + "," + inserted + "," + deleted,
            //                    ApplicationFrame.WARNING_FOREGROUND_COLOR_LOG);
        }

        public void print() {
            ApplicationFrame.getInstance().getConsole().println(this);
            if (link != null) {
                link.print();
            }
        }
        public String toString() {
            return "line0=" + line0 + ", line1=" + line1 + ", inserted="
