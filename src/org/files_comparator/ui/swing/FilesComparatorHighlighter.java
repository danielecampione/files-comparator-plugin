 ...
 * 
 */
public class FilesComparatorHighlighter implements Highlighter {
    ...
    public FilesComparatorHighlighter() {
    ...
    public void paint(Graphics g) {
        ...
        startOffset = component.viewToModel(new Point(clip.x - lineHeight,
                clip.y));
        endOffset = component.viewToModel(new Point(clip.x, clip.y
        ...
        for (Integer layer : layers) {
            ...
            for (Highlighter.Highlight hli : list) {
                ...
                hli.getPainter().paint(g, hli.getStartOffset(),
                        hli.getEndOffset(), a, component);
            }
        }
