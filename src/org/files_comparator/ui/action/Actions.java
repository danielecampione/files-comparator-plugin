...
import org.files_comparator.util.Option;
...
public class Actions {
    ...
    public final Action FOLDER_SELECT_PREVIOUS_ROW = new Action(
            "SelectPreviousRow");
    public final Action FOLDER_NEXT_NODE = new Action("NextNode");
    public final Action FOLDER_PREVIOUS_NODE = new Action("PreviousNode");
    public final Action FOLDER_OPEN_FILE_COMPARISON = new Action(
            "OpenFileComparison");
    public final Action FOLDER_OPEN_FILE_COMPARISON_BACKGROUND = new Action(
